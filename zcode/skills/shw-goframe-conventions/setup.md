...
公司特定约定（DDD 四层、手工 DI、锁定公司库异常/响应契约、decimal string）→ 指向 shw-goframe-conventions
...
| 公司 DDD 四层架构、手工 DI、锁定公司库异常/响应契约、decimal string、命名约定 | **shw-goframe-conventions** | 公司特定规则 |
