---
name: baseline
description: "Codex prompt workflow for baseline、/baseline. 最终人工验收后，为不可变版本创建或同步 API、E2E、VRT 回归基线并提交独立维护 PR。 Use only when the user explicitly asks for this named workflow."
---
