---
name: deploy
description: "Codex prompt workflow for deploy、/deploy. dev/test/生产部署协调与只读观测——核对 Fleet 同步、镜像、rollout、健康检查和回滚条件，不直接操作 Kubernetes。 Use only when the user explicitly asks for this named workflow."
---
